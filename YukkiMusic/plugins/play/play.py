    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "Tʜɪs ʙᴏᴛ ɪsɴ'ᴛ ᴀʙʟᴇ ᴛᴏ ᴘʟᴀʏ sᴘᴏᴛɪғʏ ǫᴜᴇʀɪᴇs. ᴘʟᴇᴀsᴇ ᴀsᴋ ʙᴏᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴇɴᴀʙʟᴇ sᴘᴏᴛɪғʏ."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "ᴛʜᴇʀᴇ's ᴀɴ ɪssᴜᴇ ᴡɪᴛʜ ᴛʜᴇ ʙᴏᴛ. ʀᴇᴘᴏᴛ ɪᴛ ᴛᴏ ʙᴏᴛ ᴏᴡɴᴇʀ."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "ɴɪɢɢᴀ ᴛᴜʀɴ ᴏɴ Vᴏɪᴄᴇ Cʜᴀᴛ Bᴏᴛ ɪs ɴᴏᴛ ᴀʙʟᴇ ᴛᴏ sᴛʀᴇᴀᴍ ᴜʀʟs..",
                )
            except Exception as e:
                return await mystic.edit_text(
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "ʙᴄ ʏᴏᴜ'ʀᴇ ᴀɴ Aɴᴏɴʏᴍᴏᴜs ᴀᴅᴍɪɴ\n\nɢᴏ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ's sᴇᴛᴛɪɴɢ \n⇢ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ʟɪsᴛ \n⇢ ᴄʟɪᴄᴋ ᴏɴ ʏᴏᴜʀ ɴᴀᴍᴇ \n⇢ ᴜɴᴄʜᴇᴄᴋ REMAIN ANONYMOUS ʙᴜᴛᴛᴏɴ ᴛʜᴇʀᴇ ᴏʀ ᴛᴇʟʟ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀ ʙᴄ.",
            show_alert=True,
        )
    except:
        return
