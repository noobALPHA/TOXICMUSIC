    ...
    if what in ["Users", "Chats"]:
        for items, count in list_arranged.items():
            ...
            try:
                ...
                continue
            limit += 1
            msg += f"🔗`{extract}` ᴘʟᴀʏᴇᴅ {count} ᴛɪᴍᴇ ᴏɴ Bᴏᴛ.\n\n"
        temp = (
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f"""**↳ Bᴏᴛ's sᴛᴀᴛs ᴀɴᴅ ɪɴғᴏʀᴍᴀᴛɪᴏɴ :**
...
**ᴛᴏᴛᴀʟ ᴀssɪsᴛᴀɴᴛ :** {assistant}
**ᴀss ᴀᴜᴛᴏ ʟᴇᴀᴠɪɴɢ :** {ass}
**ᴄʟᴇᴀɴ ᴍᴏᴅᴇ ᴅᴜʀᴀᴛɪᴏɴ :** {cm} ᴍɪɴs

**ᴘʟᴀʏ ᴅᴜʀᴀᴛɪᴏɴ ʟɪᴍɪᴛ :** {play_duration} ᴍɪɴs
**sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ :** {song} ᴍɪɴs
**Bᴏᴛ's Sᴇʀᴠᴇʀ Pʟᴀʏʟɪsᴛ Lɪᴍɪᴛ :** {playlist_limit}
**Pʟᴀʏʟɪsᴛ Pʟᴀɢ Lɪᴍɪᴛ :** {fetch_playlist}"""
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f""" **Bᴏᴛ's Sᴛᴀᴛs ᴀɴᴅ Iɴғʀᴏᴍᴀᴛɪᴏɴ:**
