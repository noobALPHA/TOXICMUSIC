...
async def reload_admin_cache(client, message: Message, _):
    try:
        ...
        await message.reply_text(
            "ғᴀɪʟᴅ ᴛᴏ ʀᴇʟᴏᴀᴅ ᴀᴅᴍɪɴᴄᴀᴄʜᴇ. ᴍᴀᴋᴇ sᴜʀᴇ ʙᴏᴛ ɪs ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ᴄʜᴀᴛ."
        )
...
async def restartbot(client, message: Message, _):
    mystic = await message.reply_text(
        f"ᴡᴀɪᴛ.. ʀᴇsᴛᴀʀᴛɪɴɢ {MUSIC_BOT_NAME} ғᴏʀ ʏᴏᴜʀ ᴄʜᴀᴛ.."
    )
...
async def stop_download(client, CallbackQuery: CallbackQuery, _):
    ...
    if not task:
        return await CallbackQuery.answer(
            "Dᴏᴡɴʟᴏᴀᴅɪɴɢ ᴀʟʀᴇᴀᴅʏ ᴄᴏᴍᴘʟᴇᴛᴇᴅ..", show_alert=True
        )
    if task.done() or task.cancelled():
        return await CallbackQuery.answer(
            "Dᴏᴡɴʟᴏᴀᴅ ᴀʟʀᴇᴀᴅʏ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ᴏʀ ᴄᴀɴᴄᴇʟʟᴇᴅ.",
            show_alert=True,
        )
    if not task.done():
        try:
            ...
            return await CallbackQuery.answer(
                "ғᴀɪʟᴅ ᴛᴏ sᴛᴏᴘ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.", show_alert=True
            )
    await CallbackQuery.answer(
        "ғᴀɪʟᴅ ᴛᴏ ʀᴇᴄᴏɢɴɪᴢᴇ ᴛʜᴇ ʀᴜɴɴɪɴɢ ᴛᴀsᴋ", show_alert=True
    )
